Group members:
Brett Merkosky (CCID: bamerkos)
Grace Zhu (CCID: gjzhu)
Fatih Artar (CCID: fartar)
We did not collaborate with anyone else on this project.

Information on tsv to json conversion in python was found here: https://www.geeksforgeeks.org/python-tsv-conversion-to-json/
